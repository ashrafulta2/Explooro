          ...
          <div class="referral-hub__title-wrap">
            ...
            <div class="referral-hub__header-actions">
              ...
              <button id="btn-open-qr" class="btn btn--primary btn--sm">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" class="inline-icon"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg> ${t('referrals.btn_show_qr', 'QR ও সোশ্যাল কার্ড')}
              </button>
            </div>
          </div>
        </header>
          ...
          <div class="referral-share-box">
            <div class="referral-share-row">
              ...
              <button id="btn-copy-link" class="btn btn-social btn-social--copy">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" class="inline-icon"><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path></svg> ${t('referrals.copy_link', 'লিংক কপি')}
              </button>
            </div>
            ...
            <div class="referral-social-btns">
              <a
                ...
                ${ICONS.whatsapp} ${t('referrals.share_whatsapp', 'হোয়াটসঅ্যাপ')}
              </a>
              <a
                ...
                ${ICONS.facebook} ${t('referrals.share_facebook', 'ফেসবুক')}
              </a>
              <button id="btn-copy-sms" class="btn btn--outline btn--sm">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg> ${t('referrals.share_sms', 'এসএমএস')}
              </button>
            </div>
          </div>
        </div>
