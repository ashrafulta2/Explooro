...
export default [
  ...
  },
  {
    ...
    // WHY it delegates: the Unified Inbox lists threads here but loads their messages from
    // /chat/threads/:id/messages, so a second, independent seed list would have shown three
    // conversations whose contents did not exist. One source of truth in chat.js.
    handler: () => ({
      status: 200,
