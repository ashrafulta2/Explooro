...
export const navGroups = [
  // ---- Super Admin & Admin (9 groups, ia-sitemap.md §2.1) ----
  { key: 'admin.overview', role: 'super_admin', roles: ['super_admin', 'admin'], icon: '📊', label_i18n_key: 'nav.group.overview', order: 1 },
  { key: 'admin.users', role: 'super_admin', roles: ['super_admin', 'admin'], icon: '👥', label_i18n_key: 'nav.group.admin.users', order: 2 },
  { key: 'admin.catalog', role: 'super_admin', roles: ['super_admin', 'admin'], icon: '📦', label_i18n_key: 'nav.group.catalog', order: 3 },
  { key: 'admin.orders', role: 'super_admin', roles: ['super_admin', 'admin'], icon: '🛒', label_i18n_key: 'nav.shared.orders', order: 4 },
  { key: 'admin.finance', role: 'super_admin', roles: ['super_admin', 'admin'], icon: '💰', label_i18n_key: 'nav.group.finance', order: 5 },
  { key: 'admin.growth', role: 'super_admin', roles: ['super_admin', 'admin'], icon: '📣', label_i18n_key: 'nav.group.growth', order: 6 },
  { key: 'admin.content', role: 'super_admin', roles: ['super_admin', 'admin'], icon: '✍️', label_i18n_key: 'nav.group.content', order: 7 },
  { key: 'admin.platform', role: 'super_admin', roles: ['super_admin', 'admin'], icon: '⚙️', label_i18n_key: 'nav.group.admin.platform', order: 8 },
  { key: 'admin.security', role: 'super_admin', roles: ['super_admin', 'admin'], icon: '🔒', label_i18n_key: 'nav.group.admin.security', order: 9 },
...
export const navItems = [
  // ================= SUPER ADMIN & ADMIN — 49 items =================
  { key: 'admin.dashboard', label_i18n_key: 'nav.shared.dashboard', icon: null, path: '/admin', group: 'admin.overview', permission: 'admin.dashboard.view', module: 'core', roles: ['super_admin', 'admin'], order: 1 },
  { key: 'admin.health', label_i18n_key: 'nav.admin.health', icon: null, path: '/admin/health', group: 'admin.overview', permission: 'system.health.view', module: 'core', roles: ['super_admin', 'admin'], order: 2 },

  { key: 'admin.users.list', label_i18n_key: 'nav.admin.users_list', icon: null, path: '/admin/users', group: 'admin.users', permission: 'users.account.view', module: 'core', roles: ['super_admin', 'admin'], order: 1 },
  { key: 'admin.staff', label_i18n_key: 'nav.admin.staff', icon: null, path: '/admin/staff', group: 'admin.users', permission: 'staff.account.view', module: 'core', roles: ['super_admin', 'admin'], order: 2 },
  { key: 'admin.roles', label_i18n_key: 'nav.admin.roles', icon: null, path: '/admin/roles', group: 'admin.users', permission: 'staff.role.assign', module: 'core', roles: ['super_admin', 'admin'], order: 3 },
  ...
  { key: 'admin.catalog.moderation', label_i18n_key: 'nav.admin.catalog_moderation', icon: null, path: '/admin/catalog/moderation', group: 'admin.catalog', permission: 'moderation.product.approve', module: 'product_moderation', roles: ['super_admin', 'admin'], order: 3, badge: 'catalog_moderation' },
  { key: 'admin.catalog.batches', label_i18n_key: 'nav.admin.batches', icon: null, path: '/admin/catalog/batches', group: 'admin.catalog', permission: 'catalog.batch.govern', module: 'fefo_batches', roles: ['super_admin', 'admin'], order: 4 },
  { key: 'admin.catalog.warehouses', label_i18n_key: 'nav.shared.warehouses', icon: null, path: '/admin/catalog/warehouses', group: 'admin.catalog', permission: 'catalog.warehouse.govern', module: 'multi_warehouse', roles: ['super_admin', 'admin'], order: 5 },

  { key: 'admin.orders.list', label_i18n_key: 'nav.shared.orders', icon: null, path: '/admin/orders', group: 'admin.orders', permission: 'orders.order.view_all', module: 'core', roles: ['super_admin', 'admin'], order: 1 },
  { key: 'admin.returns', label_i18n_key: 'nav.shared.returns', icon: null, path: '/admin/returns', group: 'admin.orders', permission: 'orders.return.view_all', module: 'returns_engine', roles: ['super_admin', 'admin'], order: 2 },
  { key: 'admin.disputes', label_i18n_key: 'nav.shared.disputes', icon: null, path: '/admin/disputes', group: 'admin.orders', permission: 'orders.dispute.view_all', module: 'dispute_panel', roles: ['super_admin', 'admin'], order: 3, badge: 'disputes' },
  { key: 'admin.courier', label_i18n_key: 'nav.admin.courier', icon: null, path: '/admin/courier', group: 'admin.orders', permission: 'logistics.carrier.manage', module: 'courier_hub', roles: ['super_admin', 'admin'], order: 4 },
  { key: 'admin.cod_reconciliation', label_i18n_key: 'nav.admin.cod_reconciliation', icon: null, path: '/admin/cod-reconciliation', group: 'admin.orders', permission: 'orders.cod.reconcile', module: 'cod_reconciliation', roles: ['super_admin', 'admin'], order: 5 },

  { key: 'admin.finance.overview', label_i18n_key: 'nav.shared.overview', icon: null, path: '/admin/finance', group: 'admin.finance', permission: 'finance.overview.view', module: 'core', roles: ['super_admin', 'admin'], order: 1 },
  { key: 'admin.finance.ledger', label_i18n_key: 'nav.admin.ledger', icon: null, path: '/admin/finance/ledger', group: 'admin.finance', permission: 'finance.ledger.view', module: 'core', roles: ['super_admin', 'admin'], order: 2 },
  { key: 'admin.finance.escrow', label_i18n_key: 'nav.admin.escrow', icon: null, path: '/admin/finance/escrow', group: 'admin.finance', permission: 'finance.escrow.view', module: 'escrow_engine', roles: ['super_admin', 'admin'], order: 3 },
  { key: 'admin.finance.payouts', label_i18n_key: 'nav.admin.payouts', icon: null, path: '/admin/finance/payouts', group: 'admin.finance', permission: 'finance.payout.approve', module: 'core', roles: ['super_admin', 'admin'], order: 4, badge: 'payouts' },
  { key: 'admin.finance.splits', label_i18n_key: 'nav.admin.splits', icon: null, path: '/admin/finance/splits', group: 'admin.finance', permission: 'finance.split.update', module: 'core', roles: ['super_admin', 'admin'], order: 5 },
  { key: 'admin.finance.b2b_escrow', label_i18n_key: 'nav.shared.b2b_escrow', icon: null, path: '/admin/finance/b2b-escrow', group: 'admin.finance', permission: 'finance.b2b_escrow.manage', module: 'b2b_escrow', roles: ['super_admin', 'admin'], order: 6 },
  ...
  { key: 'admin.content.academy', label_i18n_key: 'nav.shared.academy', icon: null, path: '/admin/content/academy', group: 'admin.content', permission: 'content.academy.manage', module: 'seller_academy', roles: ['super_admin', 'admin'], order: 3 },
  { key: 'admin.content.whats_new', label_i18n_key: 'nav.shared.whats_new', icon: null, path: '/admin/content/whats-new', group: 'admin.content', permission: 'content.announcement.publish', module: 'whats_new', roles: ['super_admin', 'admin'], order: 4 },
  ...
  { key: 'admin.security.2fa', label_i18n_key: 'nav.admin.2fa', icon: null, path: '/admin/security/2fa', group: 'admin.security', permission: 'security.2fa.manage', module: 'core', roles: ['super_admin', 'admin'], order: 3 },
  { key: 'admin.security.ip_allowlist', label_i18n_key: 'nav.admin.ip_allowlist', icon: null, path: '/admin/security/ip-allowlist', group: 'admin.security', permission: 'security.ip.manage', module: 'core', roles: ['super_admin', 'admin'], order: 4 },
  { key: 'admin.security.backups', label_i18n_key: 'nav.admin.backups', icon: null, path: '/admin/security/backups', group: 'admin.security', permission: 'system.backup.manage', module: 'core', roles: ['super_admin', 'admin'], order: 5 },
