...
export const THEME_PRESETS = {
  default: {
    key: 'default',
    name_en: 'Explooro Coral (Default)',
    name_bn: 'এক্সপ্লোরো কোরাল (ডিফল্ট)',
    description_en: 'Signature warm coral with balanced charcoal slate surfaces.',
    description_bn: 'সিগনেচার ওয়ার্ম কোরাল এবং সুষম চারকোল সারফেস।',
    preview_swatch: '#da694c',
    tokens: {
      navbar: {
        bg: '#ffffff',
        text: '#192026',
