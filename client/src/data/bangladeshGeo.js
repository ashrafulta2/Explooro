...
/** Complete list of all 64 administrative districts of Bangladesh in alphabetical order. */
export const ALL_BD_DISTRICTS = [
  { id: 'bagerhat', name_en: 'Bagerhat', name_bn: 'বাগেরহাট', division: 'khulna' },
  { id: 'bandarban', name_en: 'Bandarban', name_bn: 'বান্দরবান', division: 'chittagong' },
  { id: 'barguna', name_en: 'Barguna', name_bn: 'বরগুনা', division: 'barisal' },
  { id: 'barisal', name_en: 'Barishal', name_bn: 'বরিশাল', aliases: ['Barisal'], division: 'barisal' },
  { id: 'bhola', name_en: 'Bhola', name_bn: 'ভোলা', division: 'barisal' },
  { id: 'bogura', name_en: 'Bogura', name_bn: 'বগুড়া', aliases: ['Bogra'], division: 'rajshahi' },
  { id: 'brahmanbaria', name_en: 'Brahmanbaria', name_bn: 'ব্রাহ্মণবাড়িয়া', division: 'chittagong' },
  { id: 'chandpur', name_en: 'Chandpur', name_bn: 'চাঁদপুর', division: 'chittagong' },
  { id: 'chapainawabganj', name_en: 'Chapainawabganj', name_bn: 'চাঁপাইনবাবগঞ্জ', division: 'rajshahi' },
  { id: 'chattogram', name_en: 'Chattogram', name_bn: 'চট্টগ্রাম', aliases: ['Chittagong'], division: 'chittagong' },
  { id: 'chuadanga', name_en: 'Chuadanga', name_bn: 'চুয়াডাঙ্গা', division: 'khulna' },
  { id: 'coxs_bazar', name_en: "Cox's Bazar", name_bn: 'কক্সবাজার', division: 'chittagong' },
  { id: 'cumilla', name_en: 'Cumilla', name_bn: 'কুমিল্লা', aliases: ['Comilla'], division: 'chittagong' },
  ...
  { id: 'feni', name_en: 'Feni', name_bn: 'ফেনী', division: 'chittagong' },
  ...
  { id: 'jashore', name_en: 'Jashore', name_bn: 'যশোর', aliases: ['Jessore'], division: 'khulna' },
  { id: 'jhalokathi', name_en: 'Jhalokathi', name_bn: 'ঝালকাঠি', division: 'barisal' },
  ...
  { id: 'khagrachhari', name_en: 'Khagrachhari', name_bn: 'খাগড়াছড়ি', division: 'chittagong' },
  ...
  { id: 'lakshmipur', name_en: 'Lakshmipur', name_bn: 'লক্ষ্মীপুর', division: 'chittagong' },
  ...
  { id: 'noakhali', name_en: 'Noakhali', name_bn: 'নোয়াখালী', division: 'chittagong' },
  { id: 'pabna', name_en: 'Pabna', name_bn: 'পাবনা', division: 'rajshahi' },
  { id: 'panchagarh', name_en: 'Panchagarh', name_bn: 'পঞ্চগড়', division: 'rangpur' },
  { id: 'patuakhali', name_en: 'Patuakhali', name_bn: 'পটুয়াখালী', division: 'barisal' },
  { id: 'pirojpur', name_en: 'Pirojpur', name_bn: 'পিরোজপুর', division: 'barisal' },
  { id: 'rajbari', name_en: 'Rajbari', name_bn: 'রাজবাড়ী', division: 'dhaka' },
  { id: 'rajshahi', name_en: 'Rajshahi', name_bn: 'রাজশাহী', division: 'rajshahi' },
  { id: 'rangamati', name_en: 'Rangamati', name_bn: 'রাঙ্গামাটি', division: 'chittagong' },
