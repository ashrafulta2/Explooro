...
| 27 | Server-side cart + wishlist | *(gap in v1.0)* | 5.1 | ⬜ |
| 28 | Checkout: row-lock, split, COD fraud | `DFD` 4.0, `PRD` §5 | 5.2 | ⬜ |
| 29 | Payments + idempotency + webhooks | `PRD` §3.5 | 5.3 | ⬜ |
| 30 | Checkout UI + offline resilience | `PRD` §5 gap 7 | 5.4, 11.6 | ⬜ |
